    ...
    <div class="container flex gap-8">
        ...
        <div href="#" class="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row w-f  dark:border-gray-700 dark:bg-gray-800 mx-auto">
            ...
            <div class="flex flex-col justify-between p-4 leading-normal w-96">
                ...
                <p class="mb-2 font-normal text-gray-700 dark:text-gray-400"><span class="font-bold">Attack: </span>{{ pokemon.stats.attach }}</p>
                <p class="mb-2 font-normal text-gray-700 dark:text-gray-400"><span class="font-bold">Special attack: </span>{{ pokemon.stats.special_attack }}</p>
                <p class="mb-2 font-normal text-gray-700 dark:text-gray-400"><span class="font-bold">Defense: </span>{{ pokemon.stats.defense }}</p>
                <p class="mb-2 font-normal text-gray-700 dark:text-gray-400"><span class="font-bold">Special defense: </span>{{ pokemon.stats.special_defense }}</p>
                <p class="mb-2 font-normal text-gray-700 dark:text-gray-400"><span class="font-bold">Speed: </span>{{ pokemon.stats.speed }}</p>
...
<script setup>
    ...
    onMounted(async () => {
        pokemon.value = await getPokemonByName(params.name);
    })
</script>
